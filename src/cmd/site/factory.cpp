...
Factory::Factory()
{
  defs =
  {
    ...
    { "RANKS",      { 3, -1,  "ranks|ranksalias",
                      ...
                      "Syntax: SITE RANKS DAY|WEEK|MONTH|YEAR|ALL UP|DOWN SPEED|BYTES|FILES [<number>] [<section>] [<acl> ..]",
                      "Display user upload/download rankings" }, },
    { "GPRANKS",    { 3, -1,  "gpranks|gpranksalias",
                      CreatorBasePtr(new Creator<GPRANKSCommand>()),
                      "Syntax: SITE GPRANKS DAY|WEEK|MONTH|YEAR|ALL UP|DOWN SPEED|BYTES|FILES [<number>] [<section>]",
